 ...
 */
public class TimerByIntervalItem implements ListItem {
...
//        if (!TimerByIntervalItem.class.equals(item.getTag())) {
            item.removeAllViews();
            TextView text = new TextView(item.getContext());
            text.setText("Timer " + id + ": " + mSeconds + " sec");
            ...
            item.addView(text);
            item.addView(layout);
//            item.setTag(TimerByIntervalItem.class);
//        }
    }
}
